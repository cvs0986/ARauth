# Using ARauth Identity as an IAM Service

This guide explains how to use ARauth Identity IAM in your applications, similar to how you would use Keycloak, Auth0, or other IAM solutions.

## 🎯 Overview

ARauth Identity can be used in multiple ways:
...
```bash
# Build
docker build -t your-registry/arauth-identity:latest .

# Push
docker push your-registry/arauth-identity:latest

# Use in your apps
docker pull your-registry/arauth-identity:latest
```
...
Since ARauth Identity uses ORY Hydra, you can use standard OAuth2/OIDC flows:
...
import { ARauthIdentity } from '@arauth-identity/sdk';

const iam = new ARauthIdentity({
...
docker tag arauth-identity/iam-api:latest your-org/arauth-identity:latest
...
```bash
# Publish to GHCR
docker tag arauth-identity/iam-api:latest ghcr.io/your-org/arauth-identity:latest
...
- **GitHub**: [Repository](https://github.com/your-org/arauth-identity)

## ✅ Summary

**ARauth Identity can be used just like Keycloak:**
...
**Key Difference**: ARauth Identity is headless (no built-in UI), giving you full control over the user experience while providing all IAM functionality via API.
